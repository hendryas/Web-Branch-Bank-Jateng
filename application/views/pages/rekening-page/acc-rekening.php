                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($dataRekening as $rekening) : ?>
                                                        <tr class="text-center">
                                                            ...
                                                            <td>
                                                                <a href="#" class="mr-3"><span class="btn btn-sm btn-success waves-effect waves-light" data-toggle="modal" data-target="#newEditRekeningModal<?= $rekening['id']; ?>">Edit</span></a>
    ...
    foreach ($dataRekening as $rekening) :  ?>
        <div class="modal fade" id="newEditRekeningModal<?php echo $rekening['id']; ?>" tabindex="-1" aria-labelledby="newEditRekeningModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="newEditRekeningModalLabel">Edit Status Rekening</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?php echo base_url(); ?>rekening/editstatusrekening" method="POST">
                        <input type="hidden" name="id" value="<?= $rekening['id']; ?>">
                        <div class="modal-body">
                            <label for="status_rekening">Status Rekening</label>
                            <div class="form-group">
                                <select name="status_rekening" id="status_rekening" class="form-control selectpicker" data-live-search="true" required>
                                    <option value="">Select Menu</option>
