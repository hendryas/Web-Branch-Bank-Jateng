...
class Menu_model extends CI_Model
{
    ...
    public function updateDataMenuLevel2($id, $data)
    {
        $this->db->where('id', $id);
        $this->db->update('menu_level_2', $data);
    }

    public function insertDataMenuLevel2($data)
    {
        $this->db->insert('menu_level_2', $data);
    }

    public function updateDataMenuLevel1($new_id, $data)
    {
        $this->db->where('id', $new_id);
        $this->db->update('menu_level_1', $data);
    }

    public function insertDataMenuLevel1($data)
    {
